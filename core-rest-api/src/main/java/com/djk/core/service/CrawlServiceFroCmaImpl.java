...
public class CrawlServiceFroCmaImpl extends BaseSimpleCrawlService implements CrawlService
{
    ...
    private void parseData(QueryRouteVo queryRouteVo, BaseShippingCompany baseShippingCompany, ContainerDist container, JSONArray offers, BasePort fromPort, BasePort toPort, List<ProductInfo> productInfoList) throws ParseException
    {
        ...
        for (Object o : offers) {
            ...
            getFreeFee(queryRouteVo, productFeeItemList, productFeeItem, item.getString("traceId"), item.getString("OfferId"));

            getOtherFee3(queryRouteVo, productFeeItemList, productFeeItem, item.getString("traceId"), item.getString("OfferId"));
    ...
    public void getFreeFee(QueryRouteVo queryRouteVo, List<ProductFeeItem> productFeeItemList, ProductFeeItem productFeeItem, String traceId, String offerId)
    {
        int count = 0;
        while (count < Constant.MAX_REQ_COUNT) {
            count++;
    ...
    public void getOtherFee3(QueryRouteVo queryRouteVo, List<ProductFeeItem> productFeeItemList, ProductFeeItem productFeeItem, String traceId, String offerId)
    {
        int count = 0;
        while (count < Constant.MAX_REQ_COUNT) {
            count++;
