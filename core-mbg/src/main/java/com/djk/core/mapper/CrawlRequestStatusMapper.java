...
public interface CrawlRequestStatusMapper {
    ...
    List<CrawlRequestStatus> selectByExampleWithBLOBs(CrawlRequestStatusExample example);
    ...
    int updateByExampleWithBLOBs(@Param("record") CrawlRequestStatus record, @Param("example") CrawlRequestStatusExample example);
    ...
    int updateByPrimaryKeyWithBLOBs(CrawlRequestStatus record);
